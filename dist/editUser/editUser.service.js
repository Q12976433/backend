...
let EditUserService = class EditUserService {
    ...
    async updateNameByEmail(userEmail, dto) {
        const updateUser = await this.userModel.findOneAndUpdate({ email: userEmail }, Object.assign({}, dto), { new: true });
    ...
    async updateAvatarByEmail(userEmail, dto) {
        const user = await this.userModel.findOneAndUpdate({ email: userEmail }, Object.assign({}, dto), { new: true });
        return user;
    }
};
